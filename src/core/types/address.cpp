...
boost::asio::ip::tcp::endpoint NodeIdentifier::to_endpoint() const { return {ip_address_, port_number_}; }

bool NodeIdentifier::is_address_loopback() const { return ip_address_.is_loopback(); }

bool NodeIdentifier::is_address_multicast() const { return ip_address_.is_multicast(); }

bool NodeIdentifier::is_rfc3849() const {
...
bool NodeIdentifier::is_rfc6145() const {
    /*
...
bool NodeIdentifier::is_rfc1918() const {
    /*
